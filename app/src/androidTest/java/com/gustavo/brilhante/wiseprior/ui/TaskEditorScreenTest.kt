...
class TaskEditorScreenTest {
    ...
    fun setUp() {
        ...
        composeTestRule.activity.run {
            ...
            priorityNone = getString(com.gustavo.brilhante.taskeditor.R.string.none)
            priorityLow = getString(com.gustavo.brilhante.taskeditor.R.string.low)
            priorityMedium = getString(com.gustavo.brilhante.taskeditor.R.string.medium)
            priorityHigh = getString(com.gustavo.brilhante.taskeditor.R.string.high)
